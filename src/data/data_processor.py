...
def data_preprocessor(cfg: DictConfig) -> None:
    ...
    log.info(f"Instantiating train transforms <{cfg.data.train_preprocess_transforms[0]._target_}>")
    ...
    log.info(f"Instantiating valiidation transforms <{cfg.data.valid_preprocess_transforms[0]._target_}>")
